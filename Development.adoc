...
--set deploy=false \
--set namespace.name=user-group-operator-dev \
| oc apply -f -
--------------------------------------------------
...
+
-------------------------------------------
odo project set user-group-operator-dev
-------------------------------------------
...
oc policy add-role-to-user --role-namespace=user-group-operator-dev user-group-operator -z default
-------------------------------------------------------------------------
